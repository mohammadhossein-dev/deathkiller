...
def attack():
    ...
    for i in range(1, user_input.requests_count+1):
        ...
        try:
            ...
            print(Fore.RED + "[*] The request couldn't be sent, The connection reset" + Fore.RESET)
        except ConnectionRefusedError:
            print(Fore.RED + "[*] The request couldn't be sent, Server refused the connection" + Fore.RESET)
        except ConnectionAbortedError:
            print(Fore.RED + "[*] The request couldn't be sent, Server aborted the connection" + Fore.RESET)
